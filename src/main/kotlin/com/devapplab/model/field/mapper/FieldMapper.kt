...
fun CreateFieldRequest.toField(adminId: UUID): Field {
    return Field(
        ...
        organizerFee = organizerFeeInCents.toBigDecimal().movePointLeft(2),
        minimumProfitOverrideInCents = minimumProfitOverrideInCents,
        maxPricePerPlayerOverrideInCents = maxPricePerPlayerOverrideInCents,
        adminId = adminId,
...
fun FieldBaseInfo.toResponse(): FieldResponse {
    return FieldResponse(
        ...
        organizerFeeInCents = this.organizerFee.multiply(BigDecimal(100)).longValueExact(),
        minimumProfitOverrideInCents = this.minimumProfitOverrideInCents,
        maxPricePerPlayerOverrideInCents = this.maxPricePerPlayerOverrideInCents,
